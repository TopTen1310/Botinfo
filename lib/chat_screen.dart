...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  void _sendMessage() async {
    ...
    insertNewData(cm.value.choices?[0].text ?? 'Please reset and try again.');
    ttsState = TtsState.stopped;
    flutterTts
        .speak(cm.value.choices?[0].text ?? 'Please reset and try again.');
  }
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                if (ttsState == TtsState.stopped) {
                                  flutterTts.speak(cm.value.choices?[0].text ??
